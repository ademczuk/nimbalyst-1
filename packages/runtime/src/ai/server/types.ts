 ...
 */
export const AI_PROVIDER_TYPES = ['claude', 'claude-code', 'openai', 'openai-codex', 'openai-codex-acp', 'opencode', 'copilot-cli', 'kimiclaw', 'lmstudio', 'anismin', 'meridian'] as const;
